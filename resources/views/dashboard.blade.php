                ...
                <details class="w-full">
                    ...
                    <div class="bg-white flex flex-col my-4 p-8 rounded-lg shadow-lg border-2 border-gray-300">
                        <div class="text-black w-full">
                            ...
                            <a class="bg-amna-terciary-600 hover:bg-amna-terciary-500 text-white text-center font-semibold py-2 px-3 my-4 border rounded transition duration-300" href="{{ route('news.create') }}">Criar Notícia</a>
                        </div>
                    </div>  
                    <section>
                        @foreach ($user->news as $newsItem)
                            <section class="bg-white flex flex-col my-4 p-8 rounded-lg shadow-lg transition-all duration-200 hover:bg-gray-200 hover:scale-105 border-2 border-gray-300" style="font-size: 1.2em;">
                                ...
                                <div class="w-full flex justify-start">
                                    <a class="bg-amna-terciary-600 hover:bg-amna-terciary-500 text-white text-center font-semibold py-1 px-3 my-4 me-4 border rounded transition duration-300" href="{{ route('news.edit', ['news' => $newsItem]) }}">Editar</a>
                                    <a class="bg-red-700 hover:bg-red-600 text-white text-center font-semibold py-1 px-3 my-4 border rounded transition duration-300" href="{{ route('news.delete', ['news' => $newsItem->id]) }}">Deletar</a>
                                </div>
                            </section>
                        @endforeach
                    </section>
                ...
                <details class="w-full">
                    ...
                    <div class="bg-white flex flex-col my-4 p-8 rounded-lg shadow-lg border-2 border-gray-300">
                        <div class="text-black w-full">
                            ...
                            <a class="bg-amna-terciary-600 hover:bg-amna-terciary-500 text-white text-center font-semibold py-2 px-3 my-4 border rounded transition duration-300" href="{{ route('events.create') }}">Criar evento</a>
                        </div>
                    </div>  
                    <section>
                        @foreach ($events as $event)
                            <section class="bg-white flex flex-col my-4 p-8 rounded-lg shadow-lg transition-all duration-200 hover:bg-gray-200 hover:scale-105 border-2 border-gray-300" style="font-size: 1.2em;">
                                ...
                                <div class="w-full flex justify-start ">
                                    <a class="bg-amna-terciary-600 hover:bg-amna-terciary-500 text-white text-center font-semibold py-1 px-3 my-4 me-4 border rounded transition duration-300" href="{{ route('events.edit', ['event' => $event]) }}">Editar</a>
                                    <a class="bg-red-700 hover:bg-red-600 text-white text-center font-semibold py-1 px-3 my-4 border rounded transition duration-300" href="{{ route('events.delete', ['event' => $event]) }}">Deletar</a>
                                </div>
                            </section>
                        @endforeach
                    </section>

        ...
        <div class="w-full py-4 mt-4 rounded-md transition-all duration-200 lg:mt-0 md:w-[25rem] md:shadow-2xl">
            <div class="h-full w-full flex flex-col">
                ...
                <div class="w-full px-7">
                    <form class="flex justify-start items-start flex-col" action="{{ route('news.destroy', $news) }}" method="post">
                        @csrf
                        @method('delete')
                        <div>
                            <p>Tem certeza que deseja deletar a notícia <span class="font-bold">{{ $news->title }}?</span></p>

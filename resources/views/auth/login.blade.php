        ...
        <div class="w-full py-4 mt-4 rounded-md transition-all duration-200 lg:mt-0 md:w-[25rem] md:shadow-2xl">
            <div class="h-full w-full flex flex-col">
                ...
                <div class="w-full px-7">
                    <form class="flex justify-start items-start flex-col" action="{{ route('login.store') }}" method="POST">
                        @csrf
                        <div class="w-full py-2">
                            <label for="email">E-mail:</label>
                            <input class="w-full bg-white py-2 px-4 border border-black rounded" name="email" placeholder="Seu e-mail" type="email" required>
                        </div>
                        ...
                        <span class="border border-gray-500 w-full mt-5"></span>
